...
def parse_args():
    ...
    parser.add_argument(
        '--samples-per-gpu', type=int, default=None, help='the number of samples on one gpu')
    parser.add_argument(
        '--workers-per-gpu', type=int, default=None, help='the number of workers for one gpu')
    parser.add_argument(
